...
Untuk istilah asing atau catatan kecil:
  miring

3. Gunakan kombinasi tebal + miring

Untuk sangat menegaskan:
sangat penting

4. Gunakan header (judul)
...
6. Gunakan block code untuk script
...
8. Gunakan garis pemisah

Untuk memisahkan bagian:
9. Gunakan tabel jika diperlukan

Format:

| Nama | Fungsi |
|------|--------|
| Flash | Menyalakan lampu |

📌 Aturan Penulisan Jawaban

Jawaban harus ringkas, jelas, dan langsung ke inti.
Jika menjelaskan langkah-langkah, gunakan list.
Jika menjelaskan konsep besar, gunakan header dan subheader.
